        ...
        <div className="space-y-6 sm:space-y-8 sm:text-lg md:text-xl text-neutral-200 leading-relaxed">
          ...
          <div className="space-y-5 sm:space-y-6 md:space-y-8 text-sm sm:text-base md:text-lg">
            <p>
              ...
              boldly about equality. <br className="hidden sm:block" /> But
              those who held power did not like such questions.
              ...
              him — “Pottan,” which means a fool.
              <br className="hidden sm:block" /> “But he was not a fool at all,”
              the grandmother said softly to Appu. “In truth, he was wiser than
              many.” <br className="hidden sm:block" /> Despite the suffering he
              endured, Alankaran continued to speak about truth and justice.
              Through spiritual strength and mystical powers, people believed he
              could transform himself into different forms — sometimes appearing
              as animals like a deer or a fox. His loyal friend Kanadan and his
              courageous wife Sundari stood beside him, helping him awaken the
              oppressed people around them. <br className="hidden sm:block" />
              ...
              famous part of the story. <br className="hidden sm:block" />
              ...
              pot balanced on his head. <br className="hidden sm:block" />
              Shankaracharya, following the rigid rules of caste purity of that
              time, asked the man to step aside.
              <br className="hidden sm:block" />
              But Alankaran calmly replied: <br className="hidden sm:block" />
              ...
              pot upon my head… <br className="hidden sm:block" /> Where should
              I move?” <br className="hidden sm:block" /> Annoyed,
              Shankaracharya told him to move away, calling him a Chandala, a
              man of the lowest caste. <br className="hidden sm:block" /> But
              Alankaran answered with quiet wisdom:
              <br className="hidden sm:block" /> “If you cut me, does my blood
              not flow the same red? <br className="hidden sm:block" /> If you
              cut yourself, is your blood any different?
              <br className="hidden sm:block" /> If we are both made of the same
              life, <br className="hidden sm:block" /> Why then do you see such
              difference between us?” <br className="hidden sm:block" /> The
              grandmother’s voice softened. <br className="hidden sm:block" />
              ...
              Manisha Panchakam. <br className="hidden sm:block" />
              ...
              <br className="hidden sm:block" /> Over time, the people of North
              Malabar remembered this story through ritual songs and
              performances. Alankaran, the man who was once mocked as “Pottan,”
              came to be worshipped as Pottan Theyyam, a powerful deity who
              stands against injustice and reminds people of the oneness of all
              life. <br className="hidden sm:block" /> The grandmother looked at
              Appu and said gently, <br className="hidden sm:block" /> “Remember
              this, Appu… sometimes the world calls a wise person a fool. But
